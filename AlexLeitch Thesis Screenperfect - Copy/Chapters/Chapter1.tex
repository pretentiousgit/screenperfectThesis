...
\chapter{Introduction: Researching A Better Game Engine} % Main chapter title

\label{Chapter1} % For referencing the chapter elsewhere, use \ref{Chapter1} 

\lhead{Chapter 1. \emph{Researching A Better Game Engine}} % This is for the header on each page - perhaps a shortened title
...
Although artists are the central agents of production of the invisible yet tangible value of the culture industry, they are not the prime beneficiaries of the financial system that backs, stores, and distributes the results of that capital. Artists were not always expected to be broke, but they are generally broke now, thanks to the triumph of the ideal of the starving artist \site{starvingartist}. Therefore, software for artists needs to be inexpensive, and set up to be almost trivially easy to use. This reserves the value of scarcity to the \textit{ability} of the artist, rather than applying the majority value to the role of the engineer. This kind of invisibility is the invisibility of good management, of any type of good administration. Like housekeeping, code recedes until something goes wrong.
