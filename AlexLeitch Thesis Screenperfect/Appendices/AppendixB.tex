...
\label{LitReview} % For referencing the chapter elsewhere, use \ref{Chapter1} 

\lhead{Appendix B. \emph{Chapter Title Here}} % This is for the header on each page - perhaps a shortened title
